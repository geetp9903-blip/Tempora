...
export function TimeByCategoryChart({ dateRange = "7" }: { dateRange?: string }) {
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 h-[350px] sm:h-[400px] flex flex-col w-full">
      ...
      <div className="flex-1 min-h-0 flex flex-col md:flex-row items-center justify-center gap-8">
        {categoryData.length > 0 ? (
          <>
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-3 overflow-y-auto max-h-[200px] pr-2">
